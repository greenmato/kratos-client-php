...
class RegistrationFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'array<string,\OpenAPI\Client\Model\RegistrationFlowMethod>',
        'request_url' => 'string',
        'type' => 'string'
    ];
     ...
     * Gets methods
     *
     * @return array<string,\OpenAPI\Client\Model\RegistrationFlowMethod>
     */
     ...
     * Sets methods
     *
     * @param array<string,\OpenAPI\Client\Model\RegistrationFlowMethod> $methods Methods contains context for all enabled registration methods. If a registration flow has been processed, but for example the password is incorrect, this will contain error messages.
     *
     * @return self
     */
