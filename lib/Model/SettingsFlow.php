...
class SettingsFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'array<string,\OpenAPI\Client\Model\SettingsFlowMethod>',
        'request_url' => 'string',
        'state' => 'string',
        'type' => 'string'
    ];
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at ExpiresAt is the time (UTC) when the flow expires. If the user still wishes to update the setting, a new flow has to be initiated.
     *
     * @return self
     */
     ...
     * Sets issued_at
     *
     * @param \DateTime $issued_at IssuedAt is the time (UTC) when the flow occurred.
     *
     * @return self
     */
     ...
     * Gets methods
     *
     * @return array<string,\OpenAPI\Client\Model\SettingsFlowMethod>
     */
     ...
     * Sets methods
     *
     * @param array<string,\OpenAPI\Client\Model\SettingsFlowMethod> $methods Methods contains context for all enabled registration methods. If a settings flow has been processed, but for example the first name is empty, this will contain error messages.
     *
     * @return self
     */
     ...
     * Sets request_url
     *
     * @param string $request_url RequestURL is the initial URL that was requested from Ory Kratos. It can be used to forward information contained in the URL's path or query for example.
     *
     * @return self
     */
