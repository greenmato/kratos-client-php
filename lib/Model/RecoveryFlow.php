...
class RecoveryFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'array<string,\OpenAPI\Client\Model\RecoveryFlowMethod>',
        'request_url' => 'string',
        'state' => 'string',
        'type' => 'string'
    ];
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at ExpiresAt is the time (UTC) when the request expires. If the user still wishes to update the setting, a new request has to be initiated.
     *
     * @return self
     */
     ...
     * Sets issued_at
     *
     * @param \DateTime $issued_at IssuedAt is the time (UTC) when the request occurred.
     *
     * @return self
     */
     ...
     * Gets methods
     *
     * @return array<string,\OpenAPI\Client\Model\RecoveryFlowMethod>
     */
     ...
     * Sets methods
     *
     * @param array<string,\OpenAPI\Client\Model\RecoveryFlowMethod> $methods Methods contains context for all account recovery methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.
     *
     * @return self
     */
