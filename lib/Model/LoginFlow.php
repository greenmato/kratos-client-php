...
class LoginFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'methods' => 'array<string,\OpenAPI\Client\Model\LoginFlowMethod>',
        'request_url' => 'string',
        'type' => 'string'
    ];
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at ExpiresAt is the time (UTC) when the flow expires. If the user still wishes to log in, a new flow has to be initiated.
     *
     * @return self
     */
     ...
     * Sets issued_at
     *
     * @param \DateTime $issued_at IssuedAt is the time (UTC) when the flow started.
     *
     * @return self
     */
     ...
     * Gets methods
     *
     * @return array<string,\OpenAPI\Client\Model\LoginFlowMethod>
     */
     ...
     * Sets methods
     *
     * @param array<string,\OpenAPI\Client\Model\LoginFlowMethod> $methods List of login methods  This is the list of available login methods with their required form fields, such as `identifier` and `password` for the password login method. This will also contain error messages such as \"password can not be empty\".
     *
     * @return self
     */
