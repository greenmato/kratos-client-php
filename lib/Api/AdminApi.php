...
class AdminApi
{
     ...
     * Create an Identity
     *
     * @param  \OpenAPI\Client\Model\CreateIdentity $create_identity create_identity (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError
     */
    public function createIdentity($create_identity = null)
    {
        list($response) = $this->createIdentityWithHttpInfo($create_identity);
        return $response;
    }
     ...
     * Create an Identity
     *
     * @param  \OpenAPI\Client\Model\CreateIdentity $create_identity (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createIdentityWithHttpInfo($create_identity = null)
    {
        $request = $this->createIdentityRequest($create_identity);
     ...
     */
    public function createIdentityAsync($create_identity = null)
    {
        return $this->createIdentityAsyncWithHttpInfo($create_identity)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createIdentityAsyncWithHttpInfo($create_identity = null)
    {
        $returnType = '\OpenAPI\Client\Model\Identity';
        $request = $this->createIdentityRequest($create_identity);
     ...
     */
    public function createIdentityRequest($create_identity = null)
    {
        ...
        // for model (json/xml)
        if (isset($create_identity)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_identity));
            } else {
                $httpBody = $create_identity;
            }
     ...
     *
     * @param  \OpenAPI\Client\Model\CreateRecoveryLink $create_recovery_link create_recovery_link (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecoveryLink|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError
     */
    public function createRecoveryLink($create_recovery_link = null)
    {
        list($response) = $this->createRecoveryLinkWithHttpInfo($create_recovery_link);
        return $response;
    }
     ...
     * Create a Recovery Link
     *
     * @param  \OpenAPI\Client\Model\CreateRecoveryLink $create_recovery_link (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecoveryLink|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRecoveryLinkWithHttpInfo($create_recovery_link = null)
    {
        $request = $this->createRecoveryLinkRequest($create_recovery_link);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RecoveryLink' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RecoveryLink', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\RecoveryLink';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RecoveryLink',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRecoveryLinkAsync($create_recovery_link = null)
    {
        return $this->createRecoveryLinkAsyncWithHttpInfo($create_recovery_link)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRecoveryLinkAsyncWithHttpInfo($create_recovery_link = null)
    {
        $returnType = '\OpenAPI\Client\Model\RecoveryLink';
        $request = $this->createRecoveryLinkRequest($create_recovery_link);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRecoveryLinkRequest($create_recovery_link = null)
    {
        ...
        // for model (json/xml)
        if (isset($create_recovery_link)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_recovery_link));
            } else {
                $httpBody = $create_recovery_link;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse200|\OpenAPI\Client\Model\InlineResponse503
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse200|\OpenAPI\Client\Model\InlineResponse503, HTTP status code, HTTP response headers (array of strings)
     */
    public function isReadyWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 503:
                    if ('\OpenAPI\Client\Model\InlineResponse503' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InlineResponse503', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 503:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InlineResponse503',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * List Identities
     *
     * @param  int $per_page Items per Page  This is the number of items per page. (optional, default to 100)
     * @param  int $page Pagination Page (optional, default to 0)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Identity[]|\OpenAPI\Client\Model\GenericError
     */
    public function listIdentities($per_page = 100, $page = 0)
    {
        list($response) = $this->listIdentitiesWithHttpInfo($per_page, $page);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Identity[]|\OpenAPI\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listIdentitiesWithHttpInfo($per_page = 100, $page = 0)
    {
        $request = $this->listIdentitiesRequest($per_page, $page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsync($per_page = 100, $page = 0)
    {
        return $this->listIdentitiesAsyncWithHttpInfo($per_page, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsyncWithHttpInfo($per_page = 100, $page = 0)
    {
        $returnType = '\OpenAPI\Client\Model\Identity[]';
        $request = $this->listIdentitiesRequest($per_page, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitiesRequest($per_page = 100, $page = 0)
    {
        if ($per_page !== null && $per_page > 500) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling AdminApi.listIdentities, must be smaller than or equal to 500.');
        }
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling AdminApi.listIdentities, must be bigger than or equal to 1.');
        }
     ...
     * @param  \OpenAPI\Client\Model\UpdateIdentity $update_identity update_identity (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError
     */
    public function updateIdentity($id, $update_identity = null)
    {
        list($response) = $this->updateIdentityWithHttpInfo($id, $update_identity);
        return $response;
    }
     ...
     *
     * @param  string $id ID must be set to the ID of identity you want to update (required)
     * @param  \OpenAPI\Client\Model\UpdateIdentity $update_identity (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Identity|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError|\OpenAPI\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateIdentityWithHttpInfo($id, $update_identity = null)
    {
        $request = $this->updateIdentityRequest($id, $update_identity);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIdentityAsync($id, $update_identity = null)
    {
        return $this->updateIdentityAsyncWithHttpInfo($id, $update_identity)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIdentityAsyncWithHttpInfo($id, $update_identity = null)
    {
        $returnType = '\OpenAPI\Client\Model\Identity';
        $request = $this->updateIdentityRequest($id, $update_identity);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateIdentityRequest($id, $update_identity = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($update_identity)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_identity));
            } else {
                $httpBody = $update_identity;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
